...
import * as _d3 from '../d3/d3.d.ts';
import { BoxPlotData, BoxPlotMarker } from './lib/traces/box.d.ts';
import { ViolinData } from './lib/traces/violin.d.ts';
import { OhclData } from './lib/traces/ohcl.d.ts';
import { CandlestickData } from './lib/traces/candlestick.d.ts';
import { PieData } from './lib/traces/pie.d.ts';
...
export interface PlotlyHTMLElement extends HTMLElement {
    ...
    on(event: 'plotly_event', callback: (data: unknown) => void): void;
